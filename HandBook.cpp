...
void HandBook::DrawPlantFrameInfo(HDC hdc,int index)
{
	...
	GraphPlus::PaintText(hdc, Rect, L"小技巧：",10, L"微软雅黑",
		Color::Red, FontStyle::FontStyleRegular, StringAlignmentNear);
	Rect.X = Rect.X + 30;
	Rect.Y = (WIN_HEIGHT) / 5 + 205 ;
	GraphPlus::PaintText(hdc, Rect, tip,10,L"微软雅黑", 
	...
	Rect.X = WIN_WIDTH * 3 / 5 - 25 + 20;
	GraphPlus::PaintText(hdc, Rect, L"详细描述：", 10, L"微软雅黑",
	Color::Red, FontStyle::FontStyleRegular, StringAlignmentNear);
	Rect.X = Rect.X + 30;
	Rect.Y = Rect.Y + 15 ;
	GraphPlus::PaintText(hdc, Rect, info ,10, L"微软雅黑",
		Color::Black, FontStyle::FontStyleRegular, StringAlignmentNear, n);
	Rect.X = Rect.X - 30;
	Rect.Y = WIN_HEIGHT - 70;
	GraphPlus::PaintText(hdc, Rect, L"花费: " + sunNum, 12, L"微软雅黑",
		Color::Black, FontStyle::FontStyleBold, StringAlignmentNear);
	Rect.X = Rect.X + 150;
	Rect.Y = Rect.Y ;
	GraphPlus::PaintText(hdc, Rect, L"冷却: " + coolTime, 12, L"微软雅黑",
		Color::Black, FontStyle::FontStyleBold, StringAlignmentNear);
}
